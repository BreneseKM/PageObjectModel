  ...
  public abstract class Reporting {
		...
		public void reportStep(String details, String status) {
			...
			if(status.equalsIgnoreCase("pass")) {
				...
				test.log(LogStatus.INFO, details +test.addScreenCapture(".././reports/Screenshot/"+snapnumber+".png"));
			} else if(status.equalsIgnoreCase("warning")) {
				test.log(LogStatus.WARNING, details +test.addScreenCapture(".././reports/Screenshot/"+snapnumber+".png"));
			}
